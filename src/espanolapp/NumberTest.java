 ...
 * number frame, it stores the buttons and components of the frame
 *
 * @author Jazmin Vagha 16941106
 */
public class NumberTest extends javax.swing.JFrame {
     ...
     * database
     */
    public NumberTest(SpanishDB datab) {
    ...
    private void initComponents() {
        ...
        title.setText("NUMBER TEST");
        testPanel.add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, -1, -1));
...
/**
    ...
    private void optionBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionBActionPerformed
        if (question == 1 || question == 8) // say its correct
        {
    ...
    private void optionCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionCActionPerformed
        if (question == 3 || question == 4) // say its correct
        {
    ...
    private void optionDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionDActionPerformed
        if (question == 2 || question == 6 || question == 9) // say its correct
        {
    ...
    private void optionAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionAActionPerformed
        if (question == 5 || question == 7 || question == 10) // say its correct
        {
    ...
    /**
     * this method is the action that occurs when the next button is pressed
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextButtonActionPerformed
        ...
        try {
            ...
            Logger.getLogger(NumberTest.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 /**
    ...
    public void questionAns() throws SQLException {
        ...
        if (question == 1) {
            questionLabel.setText("1. What is the number uno");
            optionA.setText("FOUR");
            optionB.setText("ONE"); //correct
            optionC.setText("SEVEN");
            optionD.setText("FIVE");

        }
        if (question == 2) {
            questionLabel.setText("2. What is the number seven");
            optionA.setText("DIEZ");
            optionB.setText("CINCO");
            optionC.setText("TRES");
            optionD.setText("SIETE"); //correct
        }
        if (question == 3) {
            questionLabel.setText("3. What is the number tres");
            optionA.setText("FIVE");
            optionB.setText("TEN");
            optionC.setText("THREE"); //correct
            optionD.setText("EIGHT");
        }
        if (question == 4) {
            questionLabel.setText("4. What is the number ten");
            optionA.setText("OCHO");
            optionB.setText("SIES");
            optionC.setText("DIEZ"); //correct
            optionD.setText("UNO");
        }
        if (question == 5) {
            questionLabel.setText("5. What is the number dos");
            optionA.setText("TWO"); //correct
            optionB.setText("SIX");
            optionC.setText("FIVE");
            optionD.setText("EIGHT");
        }
        if (question == 6) {
            questionLabel.setText("6. What is the number four");
            optionA.setText("DOS");
            optionB.setText("UNO");
            optionC.setText("DIEZ");
            optionD.setText("CUATRO"); //correct
        }
        if (question == 7) {
            questionLabel.setText("7. What is the number nueve");
            optionA.setText("NINE"); //correct
            optionB.setText("FOUR");
            optionC.setText("ONE");
            optionD.setText("FIVE");
        }
        if (question == 8) {
            questionLabel.setText("8. What is the number six");
            optionA.setText("TWO");
            optionB.setText("SIES"); //correct
            optionC.setText("THREE");
            optionD.setText("EIGHT");
        }
        if (question == 9) {
            questionLabel.setText("9. What is the number cinco");
            optionA.setText("NINE");
            optionB.setText("FOUR");
            optionC.setText("TEN");
            optionD.setText("FIVE"); //correct
        }
        if (question == 10) {
            questionLabel.setText("10. What is the number eight");
            optionA.setText("OCHO"); // correct
            optionB.setText("CINCO");
            optionC.setText("NUEVE");
            optionD.setText("TRES");
